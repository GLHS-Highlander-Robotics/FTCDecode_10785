...
public class auto_red extends OpMode {
    ...
    static double tempTargetSpeed = 0;
    static Pose2D red_goal = new Pose2D(DistanceUnit.INCH, 144, 144, AngleUnit.RADIANS, 0);
    static Pose2D red_far_side_start = new Pose2D(DistanceUnit.INCH, 10, 95, AngleUnit.RADIANS, Math.toRadians(-20));
    ...
    public void init(){
        ...
        drivetrain.pinpoint.setPosition(red_far_side_start);
    }
