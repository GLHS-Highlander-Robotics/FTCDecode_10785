...
public class far_blue_9 extends OpMode{
    ...
    static double initial_spinup_time_seconds = 4, stopping_wait_time_seconds = 0.7, shooting_time_seconds = 2.7;
    boolean b = false;
    boolean shoot = false;
    double zeroHeading = 0;
    static double max_ball_pickup_power = 0.4;
    ...
    static Pose shoot_pos = new Pose(61, 10, 2);
    static Pose ballrow1_begin = new Pose(47, 32, Math.toRadians(180));
    static Pose ballrow1_end = new Pose(16, 32, Math.toRadians(180));;
    static Pose corner_begin = new Pose(13, 18, 3.5);
    static Pose corner_end = new Pose(15, 8, 3.8);
    static Pose to_corner_control = new Pose(30, 42);
    static Pose park = new Pose(24, 25, Math.toRadians(90));
